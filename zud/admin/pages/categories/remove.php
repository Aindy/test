    ...
    if (!empty($category)) {
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Удаление категории</h1>
                    </div>
                </div>
                <p class="text-danger">Вы уверены что хотите удалить эту категорию?</p>
                    <br><br>
                <p>
